...
> 설정된 브라우저에 대한 `` vendor prefix``를 자동 제공해 준다.  
...
>모두 영문사이트라 불편함이 있지만 CSS Grid System에 대한 기본을 익히고 싶으신 분들은 하기 두 사이트 만은 한 번 훑어 보시기 바랍니다.
