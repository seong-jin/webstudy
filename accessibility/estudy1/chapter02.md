...
특정한 정책안에 선택을 둘러싸고 관련 이해 당사자들이 어떠한 대안이 자신에게 유리하고 불리한지를 모르는 상황
...
|  시기   | 법률명                                      | 영역                                       |
| :---: | :--------------------------------------- | :--------------------------------------- |
| 1998년 | 재활법 508조<br>(Section 508 of Rehabilitation Act) | 연방정부에 의해 개발, 조달, 유지·보수 및 사용되는 모든 전자 정보기술(Electronic Information Technology)의 데이터와 정보 |
| 2010년 | 21세기 통신 및 비디오 접근성 법<br>(The 21st Century Communication & Video Accessibility Act of 2010) | 통신 및 비디오 프로그래밍 분야                        |
